...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { MenuController } from './../src/app/menu/menu.router';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { OrderController } from './../src/app/order/order.router';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    "IOrder": {
        ...
        "properties": {
            ...
            "userMob": {"dataType":"string","required":true},
            "orderItems": {"dataType":"array","array":{"dataType":"any"},"required":true},
        },
    ...
    "ICart": {
        "dataType": "refObject",
        "properties": {
            "mains": {"dataType":"array","array":{"dataType":"refObject","ref":"ICartItem"}},
            "drinks": {"dataType":"array","array":{"dataType":"refObject","ref":"ICartItem"}},
            "desserts": {"dataType":"array","array":{"dataType":"refObject","ref":"ICartItem"}},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/menu/getItems',
            ...
            function MenuController_getItems(request: any, response: any, next: any) {
            const args = {
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/menu/getCategories',

            function MenuController_getCategories(request: any, response: any, next: any) {
            const args = {
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/menu/generateMenu',

            function MenuController_generateMenu(request: any, response: any, next: any) {
            const args = {
            };
            ...
            const promise = controller.generateMenu.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/order/create',
            ...
            const args = {
                    order: {"in":"body","name":"order","required":true,"ref":"IOrder"},
            };
        ...
        app.post('/api/order/update',
            ...
            const args = {
                    order: {"in":"body","name":"order","required":true,"dataType":"intersection","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"id":{"dataType":"double","required":true}}},{"ref":"IOrder"}]},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/order/checkOffer',

            function OrderController_checkOffer(request: any, response: any, next: any) {
            const args = {
                    cart: {"in":"body","name":"cart","required":true,"ref":"ICart"},
            };
            ...
            const promise = controller.checkOffer.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
